# Adding attention for the show and tel model
...
glove_embeddings = np.random.rand(20000, 300)  # load glove for this....
...
class image2text():
    ...
    def __init__(self):
        ...
        with tf.variable_scope('decoder') as decoder_scope:
            ...
            self.lstm_outputs, _ = tf.nn.dynamic_rnn(cell=self.dec_cell,
